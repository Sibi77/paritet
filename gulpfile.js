...
gulp.task('sass', function () { // Создаем таск Sass
    var processors = [// подключаем постпроцессоры в массиве
        ...
        fontmagic,
        fixes,
        autoprefixer(['last 10 versions', '> 5%', 'ie 8', 'ie 7', 'ie 9', 'ie 11', 'safari 5', 'opera 12.1', 'ios 6', 'android 4'], {
            cascade: true
        }),
        sorting(),
        stylefmt,
...
gulp.task('message', function () {
    console.log('* Finish gulp.task!');
});
gulp.task('default', ['watch']);
//
// gulp.task('default', ['sass', 'png-sprite', 'css-libs', 'compress', 'extend-pages', 'img', 'message']);
